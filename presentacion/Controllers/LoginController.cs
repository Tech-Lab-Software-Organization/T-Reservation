...
namespace T_Reservation.Controllers
{
    public class LoginController : Controller
    {
        ...
        public async Task<IActionResult> Login(T_RESERVATION.EntidadesNegocio.Usuario model, string returnUrl = null)
        {
            ...
            var empleado = await LoginObj.AutenticarEmpleadoAsync(model.Correo, CalcularHashMD5(model.Password));
            ...
            if (empleado == null)
            {
                ...
                var cliente = await LoginObj.AutenticarClienteAsync(model.Correo, CalcularHashMD5(model.Password));
        ...
        private static string CalcularHashMD5(string texto)
        {
